    ...
    <Section id="about" tone="soft" className="py-20 sm:py-24 lg:py-28">
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-end">
        <Reveal className="max-w-[720px]">
          ...
          <div className="mt-5 space-y-3 text-[clamp(1.6rem,3.5vw,2.8rem)] font-semibold leading-[1.08] tracking-[-0.06em] text-white">
        ...
        <Reveal delay={0.12} className="max-w-[420px] lg:justify-self-end">
          <p className="text-base leading-7 text-white/58 sm:text-lg">{interpretation.detail}</p>
        </Reveal>
      </div>
    </Section>
  );
